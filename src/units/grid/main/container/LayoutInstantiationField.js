...
export default class LayoutInstantiationField {
    ...
    data = []   // 当前布局使用的数据
    edit = false        // 开启编辑模式，详情见 Container._edit
    animation = true   // 是否开启动画，详情见 Container._animation
    follow = true     // 是否让容器内Item跟随鼠标到最近位置
    col = null
    ...
    scroll = 'auto'
    resizeReactionDelay = 360    // 当Container大小改变时检测是否切换其他符合px限制的layout所用的时间间隔,建议间隔不要太低
