 ...
 *
 * These implementations are not meant to be used outside the ResizeObserver
...
const ResizeObserverController = /** @class */ (function () {
    ...
    ResizeObserverController.prototype.onTransitionEnd_ = function (_a) {
        const _b = _a.propertyName, propertyName = _b === void 0 ? '' : _b;
...
// can't be fully polyfill anyway.
